...
target_template = {
    'target_ws63_app_rom_template': {
        ...
        'std_libs': ['m', 'c', 'gcc'],
        'defines': ["SDK_VERSION=\"1.10.107\"", '-:CHIP_WS63=1', 'LIBCPU_UTILS', 'LIBLIB_UTILS', 'LIBPANIC', 'LIBAPP_VERSION',
    ...
    'target_ws63_boot_template': {
        ...
        'os': 'non-os',
        'std_libs': ['-:m', '-:c', 'gcc'],
        'defines': ["SDK_VERSION=\"1.10.107\"", 'CHIP_WS63=1', "CONFIG_UART_FIFO_DEPTH=64", "OSAL_NO_PAL",
