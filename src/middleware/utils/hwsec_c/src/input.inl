...
SECUREC_INLINE void  SecDecodeScanQualifier(const SecUnsignedChar **format, SecScanSpec *spec, int *finishFlag)
{
    switch (**format) {
        ...
        case SECUREC_CHAR('j'):
            ...
            spec->numberArgType = 1;
            break;
        case SECUREC_CHAR('t'): FALLTHROUGH; /* fall-through */ /* FALLTHRU */
#endif
#if SECUREC_IN_KERNEL
...
#endif
            break;
        case SECUREC_CHAR('L'): FALLTHROUGH; /* fall-through */ /* FALLTHRU */ /* For long double */
        case SECUREC_CHAR('q'):
            spec->numberWidth = SECUREC_NUM_WIDTH_LONG_LONG;
            spec->numberArgType = 1;
            break;
    ...
    while (errRet < 1 && *format != SECUREC_CHAR('\0')) {
        ...
        switch (spec.oriConvChr) {
...
#endif
                FALLTHROUGH; /* fall-through */ /* FALLTHRU */
            case 'o': FALLTHROUGH; /* fall-through */ /* FALLTHRU */
            case 'u': FALLTHROUGH; /* fall-through */ /* FALLTHRU */
            case 'd': FALLTHROUGH; /* fall-through */ /* FALLTHRU */
            case 'i': FALLTHROUGH; /* fall-through */ /* FALLTHRU */
            case 'x':
                /* Unset last char to stream */
                SecUnGetChar(spec.ch, stream, &(spec.charCount));
            ...
            case 'n': /* Char count */
                ...
                break;
            case 'e': FALLTHROUGH; /* fall-through */ /* FALLTHRU */
            case 'f': FALLTHROUGH; /* fall-through */ /* FALLTHRU */
            case 'g': /* Scan a float */
                /* Unset last char to stream */
                SecUnGetChar(spec.ch, stream, &(spec.charCount));
#if SECUREC_ENABLE_SCANF_FLOAT
