...
SECUREC_INLINE int SecDecodeSize(SecChar ch, SecFormatAttr *attr, const SecChar **format)
{
    switch (ch) {
        case SECUREC_CHAR('l'):
            ...
            break;
#ifdef SECUREC_COMPATIBLE_LINUX_FORMAT
        case SECUREC_CHAR('z'): FALLTHROUGH; /* fall-through */ /* FALLTHRU */
        case SECUREC_CHAR('Z'):
        ...
        case SECUREC_CHAR('t'):
            ...
            break;
        case SECUREC_CHAR('q'): FALLTHROUGH; /* fall-through */ /* FALLTHRU */
        case SECUREC_CHAR('L'):
        ...
        switch (state) {
            ...
            case STAT_TYPE:
                switch (ch) {
                    ...
                    case SECUREC_CHAR('G'): FALLTHROUGH; /* fall-through */ /* FALLTHRU */
                    case SECUREC_CHAR('g'): FALLTHROUGH; /* fall-through */ /* FALLTHRU */
                    case SECUREC_CHAR('E'): FALLTHROUGH; /* fall-through */ /* FALLTHRU */
                    case SECUREC_CHAR('F'): FALLTHROUGH; /* fall-through */ /* FALLTHRU */
                    case SECUREC_CHAR('e'): FALLTHROUGH; /* fall-through */ /* FALLTHRU */
                    case SECUREC_CHAR('f'): {
#if SECUREC_ENABLE_SPRINTF_FLOAT
                    ...
                    case SECUREC_CHAR('X'): FALLTHROUGH; /* fall-through */ /* FALLTHRU */
                    case SECUREC_CHAR('p'): FALLTHROUGH; /* fall-through */ /* FALLTHRU */
                    case SECUREC_CHAR('x'): /* fall-through */ /* FALLTHRU */
                        SecUpdateXpxFlags(&formatAttr, ch);
                        FALLTHROUGH; /* fall-through */ /* FALLTHRU */
                    case SECUREC_CHAR('i'): FALLTHROUGH; /* fall-through */ /* FALLTHRU */
                    case SECUREC_CHAR('d'): FALLTHROUGH; /* fall-through */ /* FALLTHRU */
                    case SECUREC_CHAR('u'): FALLTHROUGH; /* fall-through */ /* FALLTHRU */
                    case SECUREC_CHAR('o'): {
                        SecInt64 num64;
                ...
                break;
            case STAT_INVALID: FALLTHROUGH; /* fall-through */ /* FALLTHRU */
            default:
