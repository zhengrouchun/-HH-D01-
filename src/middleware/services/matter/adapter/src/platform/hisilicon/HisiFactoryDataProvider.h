...
class HisiFactoryDataProvider : public CommissionableDataProvider,
                            public Internal::GenericDeviceInstanceInfoProvider<Internal::HisiConfig>
{
public:
    HisiFactoryDataProvider()
        : CommissionableDataProvider(),
          Internal::GenericDeviceInstanceInfoProvider<Internal::HisiConfig>(ConfigurationManagerImpl::GetDefaultInstance())
    {}
