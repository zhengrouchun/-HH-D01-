...
#define WIFI_OPTIMIZE_DTCM() \
    SORT(*libwifi_driver_hmac.a:)(.data.g_wifi_2ghz_channels) \
    SORT(*libwifi_driver_hmac.a:)(.data.g_wifi_rates) \
    SORT(*libwifi_driver_hmac.a:)(.data.g_channel_list_5g) \
    SORT(*libwifi_driver_hmac.a:)(.data.g_sta_bw_switch_fsm_info) \
    SORT(*libwifi_driver_hmac.a:)(.data.g_alg_intf_det_fsm_info) \
    SORT(*libwifi_driver_hmac.a:)(.data.g_cur_regdom) \
    SORT(*libwifi_driver_hmac.a:)(.data.g_wlan_customize_etc) \
    SORT(*libwifi_driver_hmac.a:)(.data.g_channel_list_2g) \
    SORT(*libwifi_driver_hmac.a:)(.data.g_st_data_rates) \
    SORT(*libwifi_driver_hmac.a:)(.data.gst_vap_net_dev_cfg_vap_ops) \
    SORT(*libwifi_driver_hmac.a:)(.data.g_wifi_band_2ghz) \
    SORT(*libwifi_driver_hmac.a:)(.data.g_rts_11g_table) \
    SORT(*libwifi_driver_hmac.a:)(.data.g_ast_pow_dist_2g_dsss_table) \
    SORT(*libwifi_driver_hmac.a:)(.data.g_ast_pow_dist_2g_ofdm_table) \
    SORT(*libwifi_driver_hmac.a:)(.data.dfx_user_fail_reason_desc)
