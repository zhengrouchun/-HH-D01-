...
{
    mbedtls_alt_ecp_curve_type curve_type = MBEDTLS_ALT_ECP_CURVE_TYPE_INVALID;
    unsigned int klen = 0;
    ...
    return curve_type != MBEDTLS_ALT_ECP_CURVE_TYPE_INVALID;
}
    ...
    drv_pke_data *priv_key)
{
    ...
    if (ecc_type == MBEDTLS_ALT_ECP_CURVE_TYPE_RFC7748) {
