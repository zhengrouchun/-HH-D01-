...
void mbedtls_dump_point(const char* name, const mbedtls_ecp_point *point)
{
    ...
    (void)snprintf_s(xname, xyz_name_len, xyz_name_len - 1, "%s%s", name, ".x");
    (void)snprintf_s(yname, xyz_name_len, xyz_name_len - 1, "%s%s", name, ".y");
    (void)snprintf_s(zname, xyz_name_len, xyz_name_len - 1, "%s%s", name, ".z");
