...
typedef enum {
    ...
    WLAN_MSG_W2D_C_CFG_GET_VAP_STAT,
    WLAN_MSG_W2D_C_CFG_ENABLE_VAP_STAT,
    WLAN_MSG_W2D_C_CFG_GET_HW_STAT,
    WLAN_MSG_W2D_C_CFG_ENABLE_HW_STAT,
...
typedef enum {
    ...
    WLAN_MSG_W2H_CFG_GET_INTRF_INFO,
    WLAN_MSG_W2H_CFG_SET_STA_CONN_PARAS,
    WLAN_MSG_W2H_CFG_GET_DATA_FRAME_RSSI,
    WLAN_MSG_W2H_C_CFG_GET_VENDOR_IE,
    WLAN_MSG_W2H_END
} wlan_msg_w2h_enum;
...
typedef enum {
    ...
    WLAN_MSG_H2H_C_START_RADAR_SENSOR,
    WLAN_MSG_H2H_END
} wlan_msg_h2h_enum;
