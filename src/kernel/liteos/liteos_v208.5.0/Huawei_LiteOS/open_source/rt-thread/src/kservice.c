...
#define CONSOLE_TAKE          LOS_TaskLock()
#define CONSOLE_RELEASE       LOS_TaskUnlock()
#define PRINTF_BUFFER_TAKE    LOS_TaskLock()
#define PRINTF_BUFFER_RELEASE LOS_TaskUnlock()
#else
