...
void ble_uart_client_connect_change_cbk(uint16_t conn_id,
                                        bd_addr_t *addr,
...
static void ble_uart_client_discover_service_cbk(uint8_t client_id,
                                                 uint16_t conn_id,
...
static void ble_uart_client_discover_character_cbk(uint8_t client_id,
                                                   uint16_t conn_id,
...
static void ble_uart_client_discover_service_compl_cbk(uint8_t client_id,
                                                       uint16_t conn_id,
                                                       bt_uuid_t *uuid,
                                                       errcode_t status)
{
...
static void ble_uart_client_discover_character_compl_cbk(uint8_t client_id,
                                                         uint16_t conn_id,
...
static void ble_uart_client_discover_descriptor_compl_cbk(uint8_t client_id,
                                                          uint16_t conn_id,
...
static void ble_uart_client_read_cfm_cbk(uint8_t client_id,
                                         uint16_t conn_id,
...
static void ble_uart_client_indication_cbk(uint8_t client_id,
                                           uint16_t conn_id,
                                           gattc_handle_value_t *data,
                                           errcode_t status)
{
